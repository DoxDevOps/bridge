...
def get_host_details(ip_address: str, user_name: str, headers: dict) -> bool:
    ...
    if type(details) == list:
        ...
        hdd_used_in_percentiles = details[6].replace('%','')
        hdd_used_in_percentiles = 100 - int(hdd_used_in_percentiles)
        hdd_used_in_percentiles = str(hdd_used_in_percentiles)+"%"
        ...
        host_details = {"ip_address": ip_address,
                        ...
                        "hdd_remaining_in_percentiles": hdd_used_in_percentiles,
                        "total_ram": details[7],
                        "used_ram": details[8],
